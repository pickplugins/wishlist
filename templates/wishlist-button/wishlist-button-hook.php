...
function wishlist_button_wrap($atts){
    ...
    ?>
    <div class="wishlist-button-wrap" item_id="<?php echo $item_id; ?>">
        ...
        <?php if( is_user_logged_in() ) :
            ...
            if( $wishlisted_array ) {
                ...
                echo apply_filters( "wishlist_save_html", "<div class='wishlist_save wishlist_save_$item_id wishlist_saved hint--top' aria-label='Saved in ".get_the_title( $saved_in )."' wishlist_id='$saved_in'><span class='wishlist_save_icon'><i class='fa fa-heart' aria-hidden='true'></i></span></div>", $item_id );
                ...
                echo apply_filters( "wishlist_save_html", "<div class='wishlist_save wishlist_save_$item_id hint--top' aria-label='$hint_text' wishlist_id='$default_list_id'> <span class='wishlist_save_icon'><i class='fa fa-heart' aria-hidden='true'></i></span></div>", $item_id );
