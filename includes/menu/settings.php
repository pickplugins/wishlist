...
$wishlist_settings_tab[] = array(
    'id' => 'general',
    'title' => sprintf(__('%s General','wishlist'),'<i class="fas fa-list-ul"></i>'),
    'priority' => 1,
...
$wishlist_settings_tab[] = array(
    'id' => 'help_support',
    'title' => sprintf(__('%s Help & support','wishlist'),'<i class="fas fa-hands-helping"></i>'),
    'priority' => 90,
...
$wishlist_settings_tab[] = array(
    'id' => 'buy_pro',
    'title' => sprintf(__('%s Buy Pro','wishlist'),'<i class="fas fa-store"></i>'),
    'priority' => 95,
